...
import spacy
csv_path = r"C:\Users\asus\OneDrive\Desktop\Pharm-ate\pharmamate\PharmaMate\FastAPI-backend\services\symptoms_specialists.csv"
specialist_df = pd.read_csv(csv_path)
model_path = r"C:\Users\asus\OneDrive\Desktop\Pharm-ate\pharmamate\PharmaMate\FastAPI-backend\services\clinicalbert_model\clinicalbert_model"
tokenizer = BertTokenizer.from_pretrained(model_path)
model = BertForSequenceClassification.from_pretrained(model_path)

nlp = spacy.load(r"C:\Users\asus\OneDrive\Desktop\Pharm-ate\pharmamate\PharmaMate\FastAPI-backend\services\hybrid_model\spacy_ner_model")
...
def predict_specialist_and_treatment(text):
    ...
    return validated_specialist, suggested_treatment      import pandas as pd
import torch
from transformers import BertTokenizer, BertForSequenceClassification
import spacy
